                    ...
                    <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                        ...
                        <ul class="my-5 list-none p-0 flex text-900 flex-column">
                            <li class="py-2">
                                ...
                                <span class="text-xl line-height-3">24/05/22-24/07/04期间收录比赛原图还原</span>
                            </li>
                            <li class="py-2">
                                <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                <span class="text-xl line-height-3">24/05/22-24/07/04期间收录比赛挂单k线图</span>
                            </li>
                            <li class="py-2">
                                <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                <span class="text-xl line-height-3">24/05/22-24/07/04期间收录比赛北单偏离图</span>
                            </li>
                            <li class="py-2">
                                <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                <span class="text-xl line-height-3">24/05/22-24/07/04期间收录比赛自定义原图统计</span>
                            </li>
                            <li class="py-2">
                                <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                <span class="text-xl line-height-3">24/05/22-24/07/04期间收录比赛欧赔走势图</span>
                            </li>
                        </ul>
                    </div>
                </div>
